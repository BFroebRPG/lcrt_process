...
*baseline capacity* is a simple assessment of development potential basd on
...
The map below shows the suitability evaluation results.
...
mapdeck(token = key, 
  ...
  add_sf(
      data = parcels %>%
        # mutate(PrtlDOS = if_else(PrtlDOS == 1, "Partial DOS", "Full DOS")) %>%
...
expected near station areas but in lower relative proporations than at the
edges.
